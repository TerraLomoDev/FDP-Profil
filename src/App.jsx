...
const coreTopics = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Die Antwort darauf ist Bildung. Bildung ist der Schlüssel zu Aufstieg, Freiheit und echter Integration. Dafür müssen Bund und Länder endlich besser zusammenarbeiten und das Kooperationsverbot im Bildungsbereich abschaffen. Dieses Bürokratiemonster sorgt bis heute dafür, dass Verantwortung hin und her geschoben wird, statt Probleme gemeinsam zu lösen. Während Klassenzimmer marode sind, Unterricht ausfällt und Chancen verloren gehen, diskutiert die Politik darüber, wer überhaupt zuständig ist. Das ist absurd.",
        ...
        <div className="profile-grid">
          <article className="profile-intro">
            ...
            <p className="profile-bio">
              Als überzeugter <a href="./ordoliberalismus.html">Ordoliberaler</a> steht für mich die Freiheit des Individuums an erster Stelle. Staatliche
