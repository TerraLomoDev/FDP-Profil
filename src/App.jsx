...
const coreTopics = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Dieses Problem lässt sich langfristig nur europäisch lösen. Deshalb brauchen wir die konsequente Umsetzung des Gemeinsamen Europäischen Asylsystems (GEAS) und funktionierende Aufnahmezentren an den EU-Außengrenzen. Europa muss entscheiden können, wer bleiben darf und wer nicht und gleichzeitig humanitäre Verantwortung mit Ordnung und Kontrolle verbinden.",
    ],
  },
  {
    title: "Wirtschaft",
